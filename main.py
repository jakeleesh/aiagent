...
def main():
    ...
    So you should typically start by looking at the project's files, and figuring out how to run the project and how to run it's tests.
    ...
    for i in range(max_iters):
        ...
        # This loop put all functions model wants to call into messages array
